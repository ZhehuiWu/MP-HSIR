...
import sys
sys.path.append("..")
from comparison_methods.PIP import * # pip module
...
class PIPNet_Restormer_onskip_inter(nn.Module):
    def __init__(self, 
        ...
        prompt_interaction_mode = 'pip_cross_topm', # convgate # promptir_gate # promptir
        degradation_num = 6,
    ...
    def forward(self, inp_img,degradation_class = None):
        '''
...
class PIPNet_Restormer_onskip_inter2(nn.Module):
    def __init__(self, 
        inp_channels=100, 
        out_channels=100, 
        dim = 64,
        ...
        super(PIPNet_Restormer_onskip_inter2, self).__init__()
        # promptir
        ...
        self.up4_3 = Upsample(int(dim*2**2)) ## From Level 4 to Level 3
        self.reduce_chan_level3 = nn.Conv2d(int(dim*2**1) + 288, int(dim*2**2), kernel_size=1, bias=bias)
...
if __name__ == '__main__':
    ...
    net = PIPNet_Restormer_onskip_inter2(inp_channels=100, out_channels=100,dim=72).to(device)
