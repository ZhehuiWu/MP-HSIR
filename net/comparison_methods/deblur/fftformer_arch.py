...
from deblur.arch_util import fft_bench_complex_mlp
from deblur.dct_util import *
from deblur.ops_dcnv3.dcnv3_torch import DCNv3_pytorch, DCNv3_pytorch_aaai, DCNv3_pytorch_dual
...
if __name__ == '__main__':
    ...
    net = fftformer(inp_channels=31, out_channels=31, dim=48).to(device)
