...
from deblur.arch_util import LayerNorm2d
from einops import rearrange
import torch.nn.functional as F

from deblur.local_arch import Local_Base
from deblur.wavelet_block import LWN
...
if __name__ == '__main__':
    ...
    net = MLWNet(inp_channels=31, out_channels=31, dim=64).to(device)
